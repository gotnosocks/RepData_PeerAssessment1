...
This histogram shows the frequency of the new processed data.
```{r}
daily_total_steps <- tapply(activity_replace_na$steps,activity_replace_na$date, sum)
library(ggplot2)
max_steps_in_day <- max(daily_total_steps)
qplot(daily_total_steps, 
      geom = "histogram", 
      ...
      xlab = "Daily Step Total",
      ylab = "Count",
      main = "Frequency of Daily Step Totals with NAs Replaced")
```
